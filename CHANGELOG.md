...
**Note:** Version bump only for package @qoopido/lerna
...
* **build:** remove outdated crypto and use default NodeJS pkg instead ([54a812a](https://github.com/lerna-lite/lerna-lite/commit/54a812a590685e83542bd7872376ac5970712c23)) - by @ghiscoding
...
* **commands:** rename run to roll version/publish commands ([43e18e0](https://github.com/lerna-lite/lerna-lite/commit/43e18e067031e6f1c7bde7aa7cfbc5ae76549f73)) - by @ghiscoding
...
* **core:** catch of error should work with `exitCode` and/or `code` ([461ec29](https://github.com/lerna-lite/lerna-lite/commit/461ec2943ccf48393dc5f0b105c76ee5c2260772)) - by @ghiscoding
...
* **core:** replace `npm-lifecycle` with `@npmcli/run-script` ([6ab0e8d](https://github.com/lerna-lite/lerna-lite/commit/6ab0e8d90098c7d4f70bf63552c0240ba9a93e10)), closes [#60](https://github.com/lerna-lite/lerna-lite/issues/60) [#3134](https://github.com/lerna-lite/lerna-lite/issues/3134) - by @ghiscoding
...
* **deps:** move ts-node to devDependencies ([dabb00f](https://github.com/lerna-lite/lerna-lite/commit/dabb00f008807c0dfba076b66c71ce3f8c2ede8f)) - by @azu
...
* **deps:** update all non-major dependencies ([ed1db35](https://github.com/lerna-lite/lerna-lite/commit/ed1db352cd0853dd338bb4a7ebf7998b99eb9f36)) - by @renovate-bot
* **deps:** update all non-major dependencies ([27921f4](https://github.com/lerna-lite/lerna-lite/commit/27921f4a027bac239eb13d99fd2ab268781cf36c)) - by @renovate-bot
...
* **deps:** update dependency @npmcli/run-script to v4 ([29a09a9](https://github.com/lerna-lite/lerna-lite/commit/29a09a99204e7faafa626173d39ad9752efe891d)) - by @renovate-bot
...
* **deps:** update dependency @octokit/rest to v19 ([#251](https://github.com/lerna-lite/lerna-lite/issues/251)) ([d0018d7](https://github.com/lerna-lite/lerna-lite/commit/d0018d73f3b17e0d802aa998ce87004f45201d5d)) - by @renovate-bot
...
* **deps:** update dependency git-url-parse to v12 ([978bf36](https://github.com/lerna-lite/lerna-lite/commit/978bf3666c0d0cdc78e133066b3caf69d127213c)) - by @renovate-bot
...
* **deps:** update npm dependencies ([f787999](https://github.com/lerna-lite/lerna-lite/commit/f787999320763d1d68ff73ca319968be0a0d1f27)) - by @ghiscoding
* **deps:** update npm dependencies ([32da06c](https://github.com/lerna-lite/lerna-lite/commit/32da06cdcea86e38561740e95a1782f09a7add00)) - by @ghiscoding
...
* incorrect import npmlog was throwing log fn not found ([23860f9](https://github.com/lerna-lite/lerna-lite/commit/23860f900f6d77c840463452c2709e6c6b188b99)) - by @ghiscoding
...
* **logs:** disabling the advanced terminal behavior when TERM is dumb ([9994130](https://github.com/lerna-lite/lerna-lite/commit/99941301afe65ffd41f3f0cdc891b189cc19aed2)), closes [#2932](https://github.com/lerna-lite/lerna-lite/issues/2932) - by @ghiscoding
...
* **publish:** add missing `--bump` option in publish roller ([57d3db7](https://github.com/lerna-lite/lerna-lite/commit/57d3db74d855cb56dd82b3ddc870568b0ee8e0eb)) - by @ghiscoding
...
* **publish:** get a working publish command ([35f44ff](https://github.com/lerna-lite/lerna-lite/commit/35f44fffbaeec6c14b8552ee5b4a20a380945bc0)) - by @ghiscoding
* **publish:** remove bump from config to fix version rolling ([73285c9](https://github.com/lerna-lite/lerna-lite/commit/73285c92d223860d35449ac897ea0c8a352655b8)) - by @ghiscoding
...
* **publish:** skip publish when using gitDryRun ([ea97c92](https://github.com/lerna-lite/lerna-lite/commit/ea97c9289ba690c47713d7feb75f0c760b601a15)) - by @ghiscoding
* **publish:** skip publish when using gitDryRun ([9408167](https://github.com/lerna-lite/lerna-lite/commit/9408167d0dbd8a8c962a166bd71c86220610acfd)) - by @ghiscoding
* **publish:** use Lerna code for `detectFromGit` and `detectFromPackage` ([811111f](https://github.com/lerna-lite/lerna-lite/commit/811111fbc0cdd7a91f45da03c8dcd729bb34fa35)) - by @ghiscoding
...
* **url:** deprecation notice of git.io ([816b7cb](https://github.com/lerna-lite/lerna-lite/commit/816b7cbdaca6eb4411097c517c6e29c6a7008cdd)), closes [#3116](https://github.com/lerna-lite/lerna-lite/issues/3116) - by @ghiscoding
...
* **version:** add missing code conventional-preset legacy loading ([f0e105d](https://github.com/lerna-lite/lerna-lite/commit/f0e105df8acb267d00fbb46b5cc3b539af86d564)) - by @ghiscoding
...
* **version:** keep operator in `workspace:` protocol, fixes [#198](https://github.com/lerna-lite/lerna-lite/issues/198) ([1794ccd](https://github.com/lerna-lite/lerna-lite/commit/1794ccd769d90a47671a5f4b62c065cec39a401a)) - by @ghiscoding
...
* **version:** remove `workspace:` prefix on external deps, fixes [#200](https://github.com/lerna-lite/lerna-lite/issues/200) ([8d89256](https://github.com/lerna-lite/lerna-lite/commit/8d89256705e6f70b07213d823d3175c0bcf65598)) - by @ghiscoding
* **version:** remove `workspace:` prefix on peerDeps & few refactor ([6e4e5b7](https://github.com/lerna-lite/lerna-lite/commit/6e4e5b7b75effb8f48957bc098edb47a6251cee2)) - by @ghiscoding
...
* **version:** should not throw when changelog.md is missing ([eca9816](https://github.com/lerna-lite/lerna-lite/commit/eca981632fc9611f5694cb8479b0711418506a5a)) - by @ghiscoding
...
* alter `git diff` to allow independent subpackage versioning ([b15aa51](https://github.com/lerna-lite/lerna-lite/commit/b15aa510d6e8b5beccef968394e947a06a47bfb2)) - by @dlueth
...
* **core:** drastically reduce time taken to check for cycles ([ddbc9d5](https://github.com/lerna-lite/lerna-lite/commit/ddbc9d5d17e021d48fe3fa0e39fcb730b27ab8fe)), closes [#2874](https://github.com/lerna-lite/lerna-lite/issues/2874) - by @ghiscoding
* **core:** Support the `workspace:` protocol ([67d8ba1](https://github.com/lerna-lite/lerna-lite/commit/67d8ba18be5ba915547b8d8eda2c46b13f6410d2)) - by @ghiscoding
